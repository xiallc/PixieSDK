...
int main(int argc, char* argv[]) {
    ...
    retval = Pixie16BootModule(ComFPGAConfigFile, SPFPGAConfigFile, TrigFPGAConfigFile, DSPCodeFile, DSPParFile_LMTest,
    ...
    ///////////////////timing stuff/////////////////////////////
    GetLocalTime(&lt);
    t1 = 3600.0 * (double) lt.wHour + 60.0 * (double) lt.wMinute + (double) lt.wSecond +
         0.001 * (double) lt.wMilliseconds;
    ////////////////////////////////////////////////////////
    ...
    GetLocalTime(&lt);
    t2 = 3600.0 * (double) lt.wHour + 60.0 * (double) lt.wMinute + (double) lt.wSecond +
         0.001 * (double) lt.wMilliseconds;
