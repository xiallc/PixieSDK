...
function(xia_configure_target)
    ...
    if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
        ...
        if (${CMAKE_BUILD_TYPE} MATCHES "Debug")
            target_compile_options(${XIA_CT_TARGET} PUBLIC -Wall -Wextra -Werror)
        endif ()
        if (${CMAKE_COVERAGE} MATCHES "Y")
            target_compile_options(${XIA_CT_TARGET} PUBLIC --coverage)
            target_link_options(${XIA_CT_TARGET} PUBLIC --coverage)
        endif ()
