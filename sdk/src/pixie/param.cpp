...
static const channel_var_map channel_vars = {{"ChanCSRa", channel_var::ChanCSRa},
...
static const module_var module_param_var_map[] = {
    module_var::ModNum,          module_var::ModCSRA,
    module_var::ModCSRB,         module_var::ModFormat,
    module_var::MaxEvents,       module_var::SynchWait,
    module_var::InSynch,         module_var::SlowFilterRange,
    module_var::FastFilterRange, module_var::FastTrigBackplaneEna,
    module_var::CrateID,         module_var::SlotID,
    module_var::ModID,           module_var::TrigConfig,
    module_var::TrigConfig,      module_var::TrigConfig,
    module_var::TrigConfig,      module_var::HostRunTimePreset};

const copy_filter energy_filter = {
    channel_var::SlowLength, channel_var::SlowGap,      channel_var::PeakSep,
    channel_var::PeakSample, channel_var::TriggerDelay, channel_var::PAFlength,
    channel_var::BLcut,
...
const copy_filter trigger_filter = {
    channel_var::FastLength, channel_var::FastGap, channel_var::FastThresh,
